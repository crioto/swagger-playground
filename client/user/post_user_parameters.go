...
// WithUserSParameters adds the userSParameters to the post user params
func (o *PostUserParams) WithUserSParameters(userSParameters *models.User) *PostUserParams {
	o.SetUserSParameters(userSParameters)
	return o
}

// SetUserSParameters adds the userSParameters to the post user params
func (o *PostUserParams) SetUserSParameters(userSParameters *models.User) {
