...
//go:generate swagger generate server --target .. --name swagger-pg --spec ../api.yaml

func configureFlags(api *operations.SwaggerPgAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.SwaggerPgAPI) http.Handler {
